 ...
 */
final class Version20250325122249 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE search_result (id INT AUTO_INCREMENT NOT NULL, genus VARCHAR(255) DEFAULT NULL, species VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE geography CHANGE feature_primary feature_primary VARCHAR(255) DEFAULT NULL, CHANGE feature_secondary feature_secondary VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE geography CHANGE feature_primary feature_primary VARCHAR(255) NOT NULL, CHANGE feature_secondary feature_secondary VARCHAR(255) NOT NULL');
    }
}
